package edu.cit.bayonas.citmedconnect.features.medicalrecords.controller;

import edu.cit.bayonas.citmedconnect.features.medicalrecords.dto.MedicalRecordDTO;
import edu.cit.bayonas.citmedconnect.features.medicalrecords.service.MedicalRecordService;
...
public class MedicalRecordController {
    ...
    @PostMapping("/")
    public ResponseEntity<?> createMedicalRecord(@Valid @RequestBody MedicalRecordDTO medicalRecordDTO, BindingResult bindingResult) {
        try {
    ...
    public ResponseEntity<?> updateMedicalRecord(
        ...
        try {
            ...
            // Check if record exists first (before validation)
            MedicalRecordDTO existingRecord = medicalRecordService.getMedicalRecordById(id);
