package edu.cit.bayonas.citmedconnect.features.medicalrecords.service;
...
import edu.cit.bayonas.citmedconnect.features.medicalrecords.mapper.MedicalRecordMapper;
...
public class MedicalRecordService {
    ...
    public MedicalRecordDTO createMedicalRecord(MedicalRecordDTO dto) {
        ...
        System.out
                .println("Found user: " + user.getSchoolId() + " - " + user.getFirstName() + " " + user.getLastName());
        entity.setUser(user);
    ...
    public List<MedicalRecordDTO> getMedicalRecordsByUserAndDateRange(String userId, LocalDateTime startDate,
